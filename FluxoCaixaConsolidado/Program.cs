...
builder.Services.AddSwaggerGen(gen =>
{
  gen.SwaggerDoc("v1", new OpenApiInfo
  {
    ...
    Description = "Um Web API em ASP.NET Core Web API para gera��o consolidado de fluxo de caixa. � necess�rio voc� estar executando o RabbitMQ na porta padr�o para retornar consolidado conta!",
